...
50.times do
  pro = Pro.create(list_id: Faker::Number.between(1, 150), user_id: Faker::Number.between(1, 11), description: Faker::ChuckNorris.fact, weight: Faker::Number.between(1, 10))
  con = Con.create(list_id: Faker::Number.between(1, 150), user_id: Faker::Number.between(1, 11), description: Faker::StarWars.quote, weight: Faker::Number.between(1, 10))
  pro.save!
  con.save!
end
